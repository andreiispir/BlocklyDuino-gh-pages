...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  '.blocklyTreeRow:nth-child(even) {',
  '  background-color: #FFC20A;',
  '}',
  //".blocklyTreeRow:nth-child(even) {", "  background-color: #FFC20A;", "}",

  '.blocklyTreeRow:nth-child(odd) {',
  '  background-color: #0C7BDC;',
  '}',
//".blocklyTreeRow:nth-child(odd) {", "  background-color: #0C7BDC;", "}",
