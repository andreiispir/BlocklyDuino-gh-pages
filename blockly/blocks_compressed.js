...
Blockly.Blocks['blink_for'] = {
  init: function () {
    this.appendDummyInput().appendField("Blink Loop");
    this.appendValueInput("NUM").setCheck("Number").appendField("value");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColor(330);
    this.setTooltip("perform blink example for certain amount of times.");
    this.setHelpUrl("A URL");
  },

  mutationToDom: function() {
    this.sound_loop_blinking();
    return null;
  },
};
